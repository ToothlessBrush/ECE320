...
HD_PWD='C:/Vivado_labs/lab1/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log structural.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source structural.tcl -notrace
