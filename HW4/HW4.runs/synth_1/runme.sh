...
HD_PWD='C:/Vivado_labs/HW4/HW4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log twoDigitBCDAdder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source twoDigitBCDAdder.tcl
