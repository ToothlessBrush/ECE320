...
HD_PWD='C:/Vivado_labs/HW4/HW4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log twoDigitBCDAdder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source twoDigitBCDAdder.tcl -notrace
